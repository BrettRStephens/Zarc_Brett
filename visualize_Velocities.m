...
str_folder = '/Users/BrettStephens/Documents/Zarc_Brett/Encoder,IMU Measurements/';
str_file = 'AndroidVelocity_11-12-2017_07_00_31.csv';
...
legend('FL','FR','BL','BR','avg(without BL)');
xlabel('sample number');ylabel('v_x[m/s]');
